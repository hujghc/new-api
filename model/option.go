...
func InitOptionMap() {
	...
	common.OptionMap["VideoMinutePrice"] = ratio_setting.VideoMinutePrice2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "VideoMinutePrice":
		err = ratio_setting.UpdateVideoMinutePriceByJSONString(value)
	case "TopUpLink":
